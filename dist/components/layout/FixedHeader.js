...
var FixedHeader = function (_Component) {
    ...
    _createClass(FixedHeader, [{
        ...
        value: function render() {
            ...
            var tableProps = {
                className: (0, _prefix.prefix)(CLASS_NAMES.TABLE, CLASS_NAMES.HEADER_FIXED, stuck ? CLASS_NAMES.HEADER_STUCK : '', stuckToBottom ? CLASS_NAMES.HEADER_STUCK_BOTTOM : ''),
                cellSpacing: 0
            };
            ...
            if (classes.length > 0) {
                ...
                tableProps.className = (0, _prefix.prefix)(CLASS_NAMES.TABLE, CLASS_NAMES.HEADER_FIXED, stuck ? CLASS_NAMES.HEADER_STUCK : '', stuckToBottom ? CLASS_NAMES.HEADER_STUCK_BOTTOM : '');
            }
            ...
            var theadProps = {
                className: (0, _prefix.prefix)(CLASS_NAMES.THEADER, headerOffset > 0 ? 'adjusted' : '')
            };
            ...
            var containerProps = {
                className: (0, _prefix.prefix)(CLASS_NAMES.HEADER_FIXED_CONTAINER, isHidden ? 'hidden' : '')
            };
